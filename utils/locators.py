...
class AltFooterLocators(FooterLocators):
    SOCIALS = (By.XPATH, '//footer/div[@class="Socials_socialsWrap__DPtp_"]')
    YEAR = (By.XPATH, '//div[@class="FooterDark_copyrightsWrapper__xRPf8"]/p[@class="h4"]')
    COPYRIGHTS = (By.XPATH, '//div[@class="copyrightsBig FooterText_root___Rdpb "]')
    PRIVACY = (By.XPATH, '//div[@class="FooterDark_copyrightsWrapper__xRPf8"]/a[@class="text2"]')
